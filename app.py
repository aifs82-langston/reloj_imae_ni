...
st.set_page_config(page_title="Análisis de los gráficos de reloj del IMAE Nicaragua", page_icon="🔄", layout="centered")

# 2. Caché de datos
@st.cache_data
def cargar_datos():
    df = pd.read_excel('Tendencia_Ciclo_Sectores_IMAENI_05032026.xlsx', parse_dates=['Fecha'], index_col='Fecha').sort_index()
    return df
...
sectores_nombres = {
    ...
    "IMAE_Pesca": "IMAE Pesca y acuicultura",
